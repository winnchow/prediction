...
As the number of available training data is sufficiently large, the validation set approach is used. K-fold cross validation is not used (too time consuming).
...
Here shows the validation set accuracy. My model also performs very well with the validation set. The expected out of sample error is about 0.53%.
